#include <iostream>
using namespace std;
typedef enum { AVERAGE, LIGHTNESS, LUMINOSITY, SEPIA , LEFT, RIGHT} grayscale_algorithm; // definicja typu, mo¿e zmieniæ nazwê typu na inn¹
            ...
            // stworzyliœmy typ (a typ w C++ to np. char)
{
	...
	protected: // metody chronione
		...
		void to_gray_lightness();  // inny algorytm - brak
		void to_gray_luminosity(); // inny algorytm - brak
        void to_gray_sepia(); // sepia
        void to_gray_left(); // oko lewe
        void to_gray_right(); // oko prawe
